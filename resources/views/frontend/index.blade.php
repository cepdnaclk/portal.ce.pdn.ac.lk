...
<head>
    ...
    <style>
        ...
        .button-container {
            ...
            gap: 10px;
            /* Optional: Adjust the gap as needed */
        }
    </style>
    @stack('after-styles')
</head>
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-black ">
        <div class="container-fluid" style="height: 40px;">
            <a class="navbar-brand me-auto" href="#">
                <img src="https://github.com/cepdnaclk/cepdnaclk.github.io/blob/master/assets/images/crest.png?raw=true"
                    alt="department-logo" style="max-height: 38px; width: auto;" />
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasNavbarLabel">
                            <img src="https://www.ce.pdn.ac.lk/assets/images/banner.svg" alt=""
                                style="height: 45px" />
                        </h5>
