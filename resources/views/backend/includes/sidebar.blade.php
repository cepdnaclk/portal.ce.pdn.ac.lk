    ...
    <ul class="c-sidebar-nav">
        ...
        @if (
            $logged_in_user->hasAnyPermission([
                ...
                'user.access.taxonomy.list.editor',
                'user.access.taxonomy.list.viewer',
            ]))
            <li
                class="c-sidebar-nav-dropdown {{ activeClass(Route::is('dashboard.taxonomy.*') || Route::is('dashboard.taxonomy-files.*') || Route::is('dashboard.taxonomy-pages.*') || Route::is('dashboard.taxonomy-lists.*'), 'c-open c-show') }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @if ($logged_in_user->hasAnyPermission(['user.access.taxonomy.data.editor', 'user.access.taxonomy.data.viewer']))
                        <li class="c-sidebar-nav-item">
                            <x-utils.link :href="route('dashboard.taxonomy.index')" class="c-sidebar-nav-link" :text="__('Data')"
                                :active="activeClass(Route::is('dashboard.taxonomy.data.*'), 'c-active')"></x-utils.link>
                        </li>
                    @endif
                    ...
                    {{-- Taxonomy List --}}
                    @if ($logged_in_user->hasAnyPermission(['user.access.taxonomy.list.editor', 'user.access.taxonomy.list.viewer']))
                        <li class="c-sidebar-nav-item">
                            <x-utils.link :href="route('dashboard.taxonomy-lists.index')" class="c-sidebar-nav-link" :text="__('Lists')"
                                :active="activeClass(Route::is('dashboard.taxonomy-lists.*'), 'c-active')"></x-utils.link>
                        </li>
                    @endif
        ...
        @if ($logged_in_user->hasAnyPermission(['user.access.services', 'user.access.services.*']))
            {{-- Apps --}}
            <li
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    {{-- App Management  --}}
                    <x-utils.link :href="route('dashboard.services.apps')" class="c-sidebar-nav-link" :text="__('App Management')" :active="activeClass(Route::is('dashboard.services.apps'), 'c-active')" />
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    {{-- Email History  --}}
                    <x-utils.link :href="route('dashboard.services.email.history')" class="c-sidebar-nav-link" :text="__('Email History')" :active="activeClass(Route::is('dashboard.services.email.history'), 'c-active')" />
                </ul>
            </li>
        @endif
    </ul>
