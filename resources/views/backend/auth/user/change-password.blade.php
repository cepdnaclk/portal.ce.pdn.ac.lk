...
@section('content')
    <x-forms.patch :action="route('dashboard.auth.user.change-password.update', $user)">
        <x-backend.card>
            <x-slot name="header">
            ...
            <x-slot name="headerActions">
                <x-utils.link class="card-header-action" :href="route('dashboard.auth.user.index')" :text="__('Cancel')" />
            </x-slot>
