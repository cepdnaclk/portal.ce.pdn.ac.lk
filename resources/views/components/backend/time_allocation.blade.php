    ...
    <div class=" py-2 px-3 my-2" style="border: 1px solid rgb(207, 207, 207); border-radius:5px">
        ...
        <div class="row pb-2">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="input-group mb-3 col ms-3">
                        <input type="number" value="0" class="form-control" aria-describedby="key"
                            :class="!isValidInput(key) ? 'is-invalid' : ''" x-model.number="time_allocation[key]"
                            :wire:model.defer="`time_allocation.${key}`">
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="input-group mb-3 col ms-3">
                    <input type="number" class="form-control" aria-describedby="total" x-bind:value="calculateTotal()"
                        readonly>
