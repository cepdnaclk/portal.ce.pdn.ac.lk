        ...
        <template x-for="(value, key) in marks_allocation" :key="key">
            <div class="row d-flex align-items-center">
                ...
                <div class="input-group mb-3 col ms-3">
                    <input type="number" class="form-control" aria-describedby="key" :class="!isValidInput(key).valid ? 'is-invalid' : ''" x-model.number="marks_allocation[key]" :wire:model.defer="`marks_allocation.${key}`" min="0" max="100">
